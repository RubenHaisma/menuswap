...
async function removeNumbersFromDishNames(): Promise<void> {
  try {
    ...
    const updates: Array<{id: string, name: string, originalName: string}> = [];
...
async function processBatch(updates: Array<{id: string, name: string, originalName: string}>): Promise<void> {
